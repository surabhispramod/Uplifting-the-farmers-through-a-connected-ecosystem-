    ...
    <div class="wrapper">
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <?php
                ...
                $sql = "INSERT INTO `videos` (`caption`, `iframe`, `added_on`) VALUES ('$caption', '$iframe', '$date_t') ";
            ...
            <div class="card-body">
             ...
             <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                 ...
                 <input type="text" name="caption" class="form-control" maxlength="600" placeholder="Description" required>
             </div>  

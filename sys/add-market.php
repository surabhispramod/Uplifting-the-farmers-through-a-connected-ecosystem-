    ...
    <div class="wrapper">
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <?php
                ...
                $sql = "INSERT INTO `market_rate` (`corn`, `wheat`, `rice`, `ragi`, `sugarcane`, `pincode`,`updated`) VALUES ('$corn', '$wheat', '$rice', '$ragi', '$sugarcane', '$pincode', '$date_t') ";
                $results = mysqli_query($db,$sql);
                        ...
                        <?php echo'Thank you for adding Market Rates ';?></div>
            ...
            <div class="card">
            <p class="card-header sammac-media">Add Market rates for today (Price per kg) </p>    
            <div class="card-body">
              <form  method="post" action="add-market.php">
             <div class="row">
         ...
         <div class="row">
              <div class="col-md-6 form-group">
                 <label>Rice</label>
                 <input type="number" name="rice" class="form-control" maxlength="200" placeholder="Corn Rate" required>
             </div>  

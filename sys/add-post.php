    ...
    <div class="wrapper">
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <?php
                ...
                $sql = "INSERT INTO `post` (`title`, `details`, `added_on`) VALUES ('$title', '$details', '$date_t') ";
         ...
         <div class="row">
              <div class="col-md-12 form-group">
                 <label>Details</label>
                 <textarea name="details" class="form-control"placeholder="Enter Detail" required></textarea>
             </div>  

...
<!--===============================================================================================-->
    ...
    <div class="wrapper">
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <div class="card">
            <p class="card-header sammac-media">All Market Rates rates </p>    
            <div class="card-body">
                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['sugarcane'];?></td>
                             ...
                             <td>    
                  <a href="view-market.php?edited=1&idx=<?php echo $row['id']; ?>"  class="btn btn-danger"><span class="fa fa-trash"></span></a>
                              </td>  
                          </tr>
                          <?php
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $db->prepare("DELETE FROM market_rate WHERE id = ? LIMIT 1"))
                          {
                   ...
                   <script>
                       setTimeout(function () {
                        window.location.href = "view-market.php";
                        }, 1000); 

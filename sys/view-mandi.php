...
<!--===============================================================================================-->
    ...
    <div class="wrapper">
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <div class="card">
            <p class="card-header sammac-media">All mandi rates </p>    
            <div class="card-body">
              <div id="tabs-4"><table class="table table-striped thead-dark table-bordered table-hover" id="mhishi">
                ...
                <tr>
                    ...
                    <?php
                     $a=1;
                    $query=mysqli_query($db,"select *from `mandi` ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['sugarcane'];?></td>
                             ...
                             <td>    
                  <a href="view-mandi.php?edited=1&idx=<?php echo $row['id']; ?>"  class="btn btn-danger"><span class="fa fa-trash"></span></a>
                              </td>  
                          </tr>
                          <?php
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $db->prepare("DELETE FROM mandi WHERE id = ? LIMIT 1"))
                          {
                   ...
                   <script>
                       setTimeout(function () {
                        window.location.href = "view-mandi.php";
                        }, 1000); 

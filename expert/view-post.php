            ...
            <div class="card-body">
              <div id="tabs-4"><table class="table table-striped thead-dark table-bordered table-hover" id="mhishi">
                ...
                <tr>
                    ...
                    <?php
                     $a=1;
                    $query=mysqli_query($db,"select * from `post_by_expert` ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['details'];?></td>
                             ...
                             <td>    
                  <a href="view-post.php?edited=1&idx=<?php echo $row['id']; ?>"  class="btn btn-danger"><span class="fa fa-trash"></span></a>
                              </td>  
                          </tr>
                          <?php
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $db->prepare("DELETE FROM post_by_expert WHERE id = ? LIMIT 1"))
                          {

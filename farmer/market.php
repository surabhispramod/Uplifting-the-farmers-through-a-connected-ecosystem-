            ...
            <div class="card-body">
              <div id="tabs-4"><table class="table table-striped thead-dark table-bordered table-hover" id="mhishi">
                ...
                <tr>
                    ...
                    $query=mysqli_query($db,"select * from `market` where `market`.`posted_by` != '$user_logged_in' ;");
...
$user =  $row['posted_by'];
$fetch_user = mysqli_query($db, "SELECT farmers.name FROM farmers JOIN market ON farmers.id = market.posted_by WHERE market.posted_by = '$user'");
$user_row = mysqli_fetch_array($fetch_user);
echo $user_row['name'];
                        ...
                        ?>
                               ...
                               <td><?php 
            $user = $row['posted_by'];
            $fetch_user = mysqli_query($db, "SELECT * FROM `farmers` WHERE `id` = '$user'");

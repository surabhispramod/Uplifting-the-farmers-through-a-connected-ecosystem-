                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            $user =  $row['posted_by'];
                            $fetch_user = mysqli_query($db, "SELECT * FROM `farmers` WHERE `farmers`.`id` = '$user';");
                            
                            

                        ?>
                       
                            <a href="my-ads.php?edited=1&idx=<?php echo $row['id']; ?>"  class="btn btn-danger"><span class="fa fa-trash"></span></a></td>
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $db->prepare("DELETE FROM market WHERE id = ? LIMIT 1"))
                          {
